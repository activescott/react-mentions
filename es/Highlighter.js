...
var Highlighter = (_temp = _class = function (_Component) {
  ...
  Highlighter.prototype.render = function render() {
    ...
    if (selection.start === selection.end) {
      caretPositionInMarkup = mapPlainTextIndex(value, markup, selection.start, 'START', displayTransform);
    }
    ...
    iterateMentionsMarkup(value, markup, textIteratee, mentionIteratee, displayTransform);
