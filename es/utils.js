 ...
 */
export var getPositionOfCapturingGroup = function getPositionOfCapturingGroup(markup, parameterName) {
...
// `markupIteratee`.
export var iterateMentionsMarkup = function iterateMentionsMarkup(value, markup, textIteratee, markupIteratee, displayTransform) {
...
export var findStartOfMentionInPlainText = function findStartOfMentionInPlainText(value, markup, indexInPlainText, displayTransform) {
...
export var applyChangeToValue = function applyChangeToValue(value, markup, plainTextValue, selectionStartBeforeChange, selectionEndBeforeChange, selectionEndAfterChange, displayTransform) {
...
export var getPlainText = function getPlainText(value, markup, displayTransform) {
  var regex = markupToRegex(markup);
  var idPos = getPositionOfCapturingGroup(markup, 'id');
  var displayPos = getPositionOfCapturingGroup(markup, 'display');
  var typePos = getPositionOfCapturingGroup(markup, 'type');
...
export var getMentions = function getMentions(value, markup, displayTransform) {
  var mentions = [];
...
export var getEndOfLastMention = function getEndOfLastMention(value, markup, displayTransform) {
