...
import { escapeRegex, getPlainText, applyChangeToValue, findStartOfMentionInPlainText, getMentions, countSuggestions, getSuggestion, getEndOfLastMention, mapPlainTextIndex, spliceString, makeMentionsMarkup } from './utils';
...
var MentionsInput = (_temp = _class = function (_React$Component) {
  ...
  this.getPlainText = function () {
    return getPlainText(_this3.props.value || '', _this3.props.markup, _this3.props.displayTransform);
  };
  ...
  this.handleChange = function (ev) {
    ...
    var newValue = applyChangeToValue(value, markup, newPlainTextValue, _this3.state.selectionStart, _this3.state.selectionEnd, ev.target.selectionEnd, displayTransform);
    ...
    var startOfMention = findStartOfMentionInPlainText(value, markup, selectionStart, displayTransform);
    ...
    var mentions = getMentions(newValue, markup, displayTransform);
  ...
  this.updateMentionsQueries = function (plainTextValue, caretPosition) {
    ...
    var positionInValue = mapPlainTextIndex(value, markup, caretPosition, 'NULL', displayTransform);
    ...
    var substringStartIndex = getEndOfLastMention(value.substring(0, positionInValue), markup, displayTransform);
  ...
  this.addMention = function (suggestion, _ref) {
    ...
    var start = mapPlainTextIndex(value, markup, querySequenceStart, 'START', displayTransform);
